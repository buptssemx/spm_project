...
<script>
	...
	function change(){
		...
		img1.src="${pageContext.request.contextPath}/checkImgAction.action?"+new Date().getTime();
	}
</script>
</head>
<body>
	<div class="container header">
		<div class="span5">
			<div class="logo">
				<img src="${pageContext.request.contextPath}/image/timg.jpg" width="100" height="50"/>
			</div>
		</div>
		<div class="span9">
			<div class="headerAd">
					...
					<form id="registerForm" action="${pageContext.request.contextPath}/user_regist.action"  method="post" novalidate="novalidate"
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="text" id="email" name="email"
										class="text" maxlength="200" /><span><s:fielderror fieldName="email"/> </span></td>
								...
								<tr>
									...
									<td><input type="text" name="addr"
										class="text" maxlength="200"><span><s:fielderror fieldName="addr"/> </span></td>
						...
						<div class="login">
							...
							<dl>
								<dt>已经拥有账号了？</dt>
								<dd>
									立即登录即可体验商品购买！ <a href="${pageContext.request.contextPath}/user_loginPage.action">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
	...
	<div class="container footer">
		...
		<div class="span24">
			<div class="copyright">Copyright © 2017-2018  BUPT 版权所有</div>
		</div>
	</div>
	<div id="_my97DP"
