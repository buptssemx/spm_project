...
<div class="span10 last">
	<div class="topNav clearfix">
		<ul>
			...
			<li id = "headeradminlogin" class = "headeradminlogin" style="display: list-item;">
			<a href="${pageContext.request.contextPath}/admin/index.jsp">管理员登陆</a> |</li>
			<!-- 
			<li><a>购物指南</a> |</li>
			<li><a>关于我们</a></li>
			 -->
